...
<div class="text-light" style="height: 120vh; background-image: url({{Vite::image('home_bg.jpg')}});" width=100%>
    <div class="border1">
        ...
        <div class="mb-3" style="justify-content: center; display: flex">
            <a class="btn btn-primary" href="{{route('products')}}" role="button" style="font-family: Lexend; text-align: center; background: #a72322; width: 15vw; border-radius: 30px;">Order Now</a>
        </div>
    </div>
</div>
