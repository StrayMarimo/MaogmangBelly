...
<div class="row d-flex justify-content-center m-3">
    <div class="mb-5 mt-5">
        ...
        <p class="cap1 mb-4" style="color: black"> Indulge in the flavors of our featured food products - each one a
            culinary masterpiece <br>
    ...
    <div>
        ...
        <p class="cap1 mb-4" style="color: black"> From classic favorites to exciting new flavors, our selection of food
            products will tantalize your taste buds <br>
