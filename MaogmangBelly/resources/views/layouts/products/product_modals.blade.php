...
<div class="modal fade" id="editProductModal" data-categories="" tabindex="-1" aria-labelledby="edit-product-modal-label"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <!-- Edit Product form -->
            <form action="{{ route('edit_product')}}" method="POST" enctype="multipart/form-data" id="editProductForm" style="margin: 20px; line-height: 2.5;">
                @csrf
                <!-- Save product ID -->
                ...
                <!-- Input for product price for 10pax-->
                <div class="form-box form-floating mb-3 col-md-auto">
                    <input type="number" id="price10" name="product_price_10" min="0" max="1000000"
                        step="0.01" class="boxbox form-control @error('product_price_10') is-invalid @enderror"
                ...
                <div class="form-box form-floating mb-3 col-md-auto">
                    <input id="stock" type="number" class="boxbox form-control @error('product_stock') is-invalid @enderror" name="product_stock" min="0" max="1000000" value="{{ old('product_stock') }}" required autocomplete="product_stock" autofocus>
                ...
                <div class="row mb-3">
                    <div class="col-sm-6">
                        <img id="preview-image-before-upload" src="{{ asset('/assets/product_assets/spaghetti.jpg') }}" alt="preview image" style="height: 216px; width: 288px; object-fit: cover;" class="mb-2">
                        <input class="form-control @error('img') is-invalid @enderror" type="file" name="img" id="img" accept="image/*" required>
                        <!-- Display error message if file upload fails -->
                        @error('img')
                        <span class="invalid-feedback" role="alert" style="mb-2">
                            <strong>{{ $message }}</strong>
