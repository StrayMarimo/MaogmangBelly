...
<body width="100%" bgcolor="#F1F1F1" style="margin: 0; mso-line-height-rule: exactly;">
    <center style="width: 100%; background: #F1F1F1; text-align: left;">
        <div
            ...
            A customer has contacted Maogmang Belly! See their message.</div>
                        ...
                        <tr>
                            <td style="padding: 40px 40px 20px 40px; text-align: left;">
                                <h1
                                    ...
                                    {{ $mailData['name'] }} wants to contact you.</h1>
                            </td>
                        </tr>
                        <tr>
                            <td
                                ...
                                <p style="margin: 0;">From: {{ $mailData['email'] }} <br></p>
                            </td>
                        </tr>
                        <tr>
                            <td
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"> <br>
                        ...
                        <tr>
                            <td
                                ...
                                <p style="margin: 0;">This email was sent to you from {{ $mailData['email'] }}</p>
                            </td>
                        </tr>
                        <tr>
                            <td
