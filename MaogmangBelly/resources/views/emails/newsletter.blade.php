    ...
    <center style="width: 100%; background: #F1F1F1; text-align: left;">
        ...
        <div style="max-width: 680px; margin: auto;" class="email-container">
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%"
                ...
                <tr>
                    <td background="https://images.unsplash.com/photo-1578474846511-04ba529f0b88?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td valign="top"
                                                    ...
                                                    <p style="margin: 0;">You are now on the list -- and will be the
                                                        first to know about our latest products and promos,
                                                        ...
                                                        <table role="presentation" align="center" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td style="border-radius: 50px; background: #26a4d3; text-align: center;"
                                                                    class="button-td"> <a href="http://127.0.0.1:8000/"
                                                                        style="background: #c1272d;; border: 15px solid #c1272d;;; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 50px; font-weight: bold;"
                                                                        class="button-a"> <span style="color:#ffffff;"
                                                                            class="button-link">&nbsp;&nbsp;&nbsp;&nbsp;Visit
                                                                            Website&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                                    </a>
                                                                </td>
                                                            </tr>
                            ...
                            <tr>
                                <td style="padding: 40px 40px 20px 40px; text-align: left;">
                                    <h1
                                        ...
                                        YOU ARE NOW SUBSCRIBED TO OUR EMAIL NEWSLETTER!</h1>
                                </td>
                            </tr>
                            <tr>
                                <td
                                    ...
                                    <p style="margin: 0;">Thank you for choosing Maogmang Belly.</p>
                                </td>
                            </tr>
                            <tr>
                                <td
                                    ...
                                    <p style="margin: 0;">We take pride in providing exceptional culinary experiences
                                        that are tailored to your unique tastes and preferences
                                        offering a wide range of catering services that are designed to make your event
                                        unforgettable.</p>
                                </td>
                            </tr>
                        </table>
